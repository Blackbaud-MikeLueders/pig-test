-- Clear Outputs
rmf $OUTPUT/out_members_to_remove.gz
rmf $OUTPUT/out_members_to_add.gz
...
STORE members_to_remove INTO '$OUTPUT/out_members_to_remove.gz' USING PigStorage();
STORE members_to_add INTO '$OUTPUT/out_members_to_add.gz' USING PigStorage();

fs -getmerge $OUTPUT/out_members_to_remove.gz $OUTPUT/members_to_remove.gz
fs -getmerge $OUTPUT/out_members_to_add.gz $OUTPUT/members_to_add.gz